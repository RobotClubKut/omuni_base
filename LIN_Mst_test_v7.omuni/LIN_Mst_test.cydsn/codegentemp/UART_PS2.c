...
uint8 UART_PS2_initVar = 0u;
    ...
    volatile uint8 UART_PS2_txBuffer[UART_PS2_TXBUFFERSIZE];
    ...
    volatile uint8 UART_PS2_rxBuffer[UART_PS2_RXBUFFERSIZE];
    ...
    volatile uint8 UART_PS2_rxBufferOverflow = 0u;
        ...
        volatile uint8 UART_PS2_rxAddressMode = UART_PS2_RXADDRESSMODE;
...
void UART_PS2_Init(void) 
{
        ...
        #if(UART_PS2_RX_INTERRUPT_ENABLED && (UART_PS2_RXBUFFERSIZE > UART_PS2_FIFO_LENGTH))
            /* Set the RX Interrupt. */
            (void)CyIntSetVector(UART_PS2_RX_VECT_NUM, &UART_PS2_RXISR);
            CyIntSetPriority(UART_PS2_RX_VECT_NUM, UART_PS2_RX_PRIOR_NUM);
        #endif /* End UART_PS2_RX_INTERRUPT_ENABLED */

        #if (UART_PS2_RXHW_ADDRESS_ENABLED)
            UART_PS2_SetRxAddressMode(UART_PS2_RXAddressMode);
            UART_PS2_SetRxAddress1(UART_PS2_RXHWADDRESS1);
            UART_PS2_SetRxAddress2(UART_PS2_RXHWADDRESS2);
        ...
        #if(UART_PS2_TX_INTERRUPT_ENABLED && (UART_PS2_TXBUFFERSIZE > UART_PS2_FIFO_LENGTH))
        ...
        /* Write Counter Value for TX Bit Clk Generator*/
            ...
            UART_PS2_TXBITCLKTX_COMPLETE_REG = (UART_PS2_NUMBER_OF_DATA_BITS +
                        UART_PS2_NUMBER_OF_START_BIT) * UART_PS2_OVER_SAMPLE_COUNT;
        #else
...
void UART_PS2_Enable(void) 
{
    ...
    enableInterrupts = CyEnterCriticalSection();
        ...
        #if(UART_PS2_RX_INTERRUPT_ENABLED && (UART_PS2_RXBUFFERSIZE > UART_PS2_FIFO_LENGTH))
            CyIntEnable(UART_PS2_RX_VECT_NUM);
            #if (UART_PS2_RXHW_ADDRESS_ENABLED)
        ...
        #if(UART_PS2_TX_INTERRUPT_ENABLED && (UART_PS2_TXBUFFERSIZE > UART_PS2_FIFO_LENGTH))
            CyIntEnable(UART_PS2_TX_VECT_NUM);
        #endif /* End UART_PS2_TX_INTERRUPT_ENABLED*/
     #endif /* End UART_PS2_TX_ENABLED */

    #if(UART_PS2_INTERNAL_CLOCK_USED)
        /* Enable the clock. */
        UART_PS2_IntClock_Start();
    #endif /* End UART_PS2_INTERNAL_CLOCK_USED */
...
void  UART_PS2_WriteControlRegister(uint8 control) 
{
       ...
       UART_PS2_CONTROL_REG = control;
        ...
        /*******************************************************************************
        * Function Name: UART_PS2_EnableRxInt
        ********************************************************************************
        *
        * Summary:
        ...
        *
        *******************************************************************************/
        void UART_PS2_EnableRxInt(void) 
        {
            CyIntEnable(UART_PS2_RX_VECT_NUM);
        }
        ...
        /*******************************************************************************
        * Function Name: UART_PS2_DisableRxInt
        ********************************************************************************
        *
        * Summary:
        ...
        *
        *******************************************************************************/
        void UART_PS2_DisableRxInt(void) 
        {
            CyIntDisable(UART_PS2_RX_VECT_NUM);
        }
    ...
    *  UART_PS2_rxBufferLoopDetect - creared if loop condition was detected
    *     in RX ISR.
    *
    * Reentrant:
    *  No.
    ...
    *******************************************************************************/
    uint8 UART_PS2_ReadRxData(void) 
    {
        uint8 rxData;
        ...
        #if(UART_PS2_RXBUFFERSIZE > UART_PS2_FIFO_LENGTH)
            ...
            /* Disable Rx interrupt. */
                ...
                UART_PS2_DisableRxInt();
            #endif /* UART_PS2_RX_INTERRUPT_ENABLED */
            loc_rxBufferRead = UART_PS2_rxBufferRead;
            loc_rxBufferWrite = UART_PS2_rxBufferWrite;

            if( (UART_PS2_rxBufferLoopDetect != 0u) || (loc_rxBufferRead != loc_rxBufferWrite) )
            {
                rxData = UART_PS2_rxBuffer[loc_rxBufferRead];
                loc_rxBufferRead++;

                if(loc_rxBufferRead >= UART_PS2_RXBUFFERSIZE)
                {
                    loc_rxBufferRead = 0u;
                }
                /* Update the real pointer */
                UART_PS2_rxBufferRead = loc_rxBufferRead;
        ...
        #else /* UART_PS2_RXBUFFERSIZE > UART_PS2_FIFO_LENGTH */

            /* Needs to check status for RX_STS_FIFO_NOTEMPTY bit*/
            rxData = UART_PS2_RXDATA_REG;

        #endif /* UART_PS2_RXBUFFERSIZE > UART_PS2_FIFO_LENGTH */
    ...
    *******************************************************************************/
                                                            ...
                                                            
    {
        uint8 size;
            ...
            {
                size = (UART_PS2_RXBUFFERSIZE - UART_PS2_rxBufferRead) + UART_PS2_rxBufferWrite;
            }
    ...
    *******************************************************************************/
    void UART_PS2_ClearRxBuffer(void) 
    {
        ...
        enableInterrupts = CyEnterCriticalSection();
        UART_PS2_RXDATA_AUX_CTL_REG |=  UART_PS2_RX_FIFO_CLR;
    ...
    *******************************************************************************/
    void UART_PS2_SetRxAddress2(uint8 address) 
    {
        ...
        /*******************************************************************************
        * Function Name: UART_PS2_EnableTxInt
        ********************************************************************************
        *
        * Summary:
        ...
        *
        *******************************************************************************/
        void UART_PS2_EnableTxInt(void) 
        {
            CyIntEnable(UART_PS2_TX_VECT_NUM);
        }
        ...
        /*******************************************************************************
        * Function Name: UART_PS2_DisableTxInt
        ********************************************************************************
        *
        * Summary:
        ...
        *
        *******************************************************************************/
        void UART_PS2_DisableTxInt(void) 
        {
            CyIntDisable(UART_PS2_TX_VECT_NUM);
        }
    ...
    *******************************************************************************/
    void UART_PS2_WriteTxData(uint8 txDataByte) 
    {
        ...
        if(UART_PS2_initVar != 0u)
        {
            #if(UART_PS2_TXBUFFERSIZE > UART_PS2_FIFO_LENGTH)
                ...
                {
                    if(UART_PS2_txBufferWrite >= UART_PS2_TXBUFFERSIZE)
                    {
            ...
            #else /* UART_PS2_TXBUFFERSIZE > UART_PS2_FIFO_LENGTH */

                /* Add directly to the FIFO. */
                UART_PS2_TXDATA_REG = txDataByte;

            #endif /* End UART_PS2_TXBUFFERSIZE > UART_PS2_FIFO_LENGTH */
        }
    }
    ...
    void UART_PS2_PutChar(uint8 txDataByte) 
    {
                ...
                */
                ...
                do{
                    ...
                    #if ((UART_PS2_TXBUFFERSIZE > UART_PS2_MAX_BYTE_VALUE) && (CY_PSOC3))
                        /* Disable TX interrupt to protect variables that could change on interrupt */
                        CyIntDisable(UART_PS2_TX_VECT_NUM);
                    #endif /* End TXBUFFERSIZE > 255 */
                    loc_txBufferWrite = UART_PS2_txBufferWrite;
                    loc_txBufferRead = UART_PS2_txBufferRead;
                    #if ((UART_PS2_TXBUFFERSIZE > UART_PS2_MAX_BYTE_VALUE) && (CY_PSOC3))
                        ...
                        CyIntEnable(UART_PS2_TX_VECT_NUM);
                                        ...
                                        (uint8)(UART_PS2_TXBUFFERSIZE - 1u)) );
                ...
                {
                    if(loc_txBufferWrite >= UART_PS2_TXBUFFERSIZE)
                    {
                        loc_txBufferWrite = 0u;
                    }
                    /* Add to the software buffer. */
                    UART_PS2_txBuffer[loc_txBufferWrite] = txDataByte;
                    loc_txBufferWrite++;
                    ...
                    /* Finally, update the real output pointer */
                        ...
                        CyIntDisable(UART_PS2_TX_VECT_NUM);
                    #endif /* End TXBUFFERSIZE > 255 */
                    UART_PS2_txBufferWrite = loc_txBufferWrite;
                    #if ((UART_PS2_TXBUFFERSIZE > UART_PS2_MAX_BYTE_VALUE) && (CY_PSOC3))
                        CyIntEnable(UART_PS2_TX_VECT_NUM);
                    #endif /* End TXBUFFERSIZE > 255 */
                }
    ...
    *******************************************************************************/
    void UART_PS2_PutString(const char8 string[]) 
    {
        ...
        if(UART_PS2_initVar != 0u)
        {
            ...
            {
                UART_PS2_PutChar((uint8)string[buf_index]);
                buf_index++;
            }
        }
    }
    ...
    *******************************************************************************/
                                                                    ...
                                                                    
    {
        ...
        if(UART_PS2_initVar != 0u)
        {
            do
            {
                UART_PS2_PutChar(string[buf_index]);
                buf_index++;
    ...
    *******************************************************************************/
                                                            ...
                                                            
    {
        uint8 size;
            ...
            {
                size = (UART_PS2_TXBUFFERSIZE - UART_PS2_txBufferRead) + UART_PS2_txBufferWrite;
            }
    ...
    *******************************************************************************/
    void UART_PS2_ClearTxBuffer(void) 
    {
        ...
        enableInterrupts = CyEnterCriticalSection();
        /* clear the HW FIFO */
        UART_PS2_TXDATA_AUX_CTL_REG |=  UART_PS2_TX_FIFO_CLR;
        ...
        if(UART_PS2_initVar != 0u)
        {
            ...
            uint8 tmpStat;
                    ...
                    (retMode == UART_PS2_SEND_WAIT_REINIT) )
                {
                    ...
                    #if(UART_PS2_TXCLKGEN_DP)
                        tx_period = UART_PS2_TXBITCLKTX_COMPLETE_REG;
                        UART_PS2_TXBITCLKTX_COMPLETE_REG = UART_PS2_TXBITCTR_BREAKBITS;
                    #else
                        tx_period = UART_PS2_TXBITCTR_PERIOD_REG;
                    ...
                    (retMode == UART_PS2_SEND_WAIT_REINIT) )
                {
                    ...
                    #if(UART_PS2_TXCLKGEN_DP)
                        UART_PS2_TXBITCLKTX_COMPLETE_REG = tx_period;
                    #else
                        UART_PS2_TXBITCTR_PERIOD_REG = tx_period;
                    #endif /* End UART_PS2_TXCLKGEN_DP */
    ...
    *******************************************************************************/
    void UART_PS2_LoadTxConfig(void) 
    {
        ...
        UART_PS2_RXBITCTR_PERIOD_REG = UART_PS2_HD_TXBITCTR_INIT;
            ...
            CY_GET_REG8(UART_PS2_RXSTATUS_PTR);
        #endif /* CY_UDB_V0 */
    }
