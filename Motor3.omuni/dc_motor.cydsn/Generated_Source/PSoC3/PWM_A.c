...
void PWM_A_Init(void) 
{
        ...
        ctrl = PWM_A_CONTROL & ((uint8)(~PWM_A_CTRL_CMPMODE2_MASK)) & ((uint8)(~PWM_A_CTRL_CMPMODE1_MASK));
    ...
    /* Globally disable the Fixed Function Block chosen */
		...
		*******************************************************************************/
		void PWM_A_SetCompareMode(uint8 comparemode) 
		{
		        ...
		        /*Clear existing mode */
		        PWM_A_CONTROL &= ((uint8)(~(PWM_A_CTRL_CMPMODE1_MASK | PWM_A_CTRL_CMPMODE2_MASK))); 
...
void PWM_A_WritePeriod(uint16 period) 
{
    ...
    *******************************************************************************/
    uint8 PWM_A_ReadStatusRegister(void)   
    {
    	...
    	result = CY_GET_REG8(PWM_A_STATUS_PTR);
    	return (result);
    }
