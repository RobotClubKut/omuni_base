...
void PWM_B_Init(void) 
{
        ...
        ctrl = PWM_B_CONTROL & ((uint8)(~PWM_B_CTRL_CMPMODE2_MASK)) & ((uint8)(~PWM_B_CTRL_CMPMODE1_MASK));
    ...
    /* Globally disable the Fixed Function Block chosen */
		...
		*******************************************************************************/
		void PWM_B_SetCompareMode(uint8 comparemode) 
		{
		        ...
		        /*Clear existing mode */
		        PWM_B_CONTROL &= ((uint8)(~(PWM_B_CTRL_CMPMODE1_MASK | PWM_B_CTRL_CMPMODE2_MASK))); 
...
void PWM_B_WritePeriod(uint8 period) 
{
    ...
    *******************************************************************************/
    uint8 PWM_B_ReadStatusRegister(void)   
    {
    	...
    	result = CY_GET_REG8(PWM_B_STATUS_PTR);
    	return (result);
    }
